...
import game.interfaces.GameManagerInterface;
...
public class GameManager implements GameManagerInterface {
	...
	public boolean playGame() {
		...
		try 
		{
			...
			{
				 for(Map.Entry<Piece, PlayerInterface> entry : players.entrySet())
				 {
					 ...
					 //TODO make player concede after set amount of tries
					 while(!movePlaced)
					 {
			...
			System.out.println("All positions taken. No more moves can be made.");
			return false;
		} catch (InvalidColourException e) {
	...
	private boolean placePiece(Piece colour, Move move) throws NoBoardDefinedException, InvalidColourException
	{
		try {
			board.placePiece(colour, move);
			
		} catch (PositionAlreadyTakenException e) {
			System.out.println("This position is alrady taken. Restarting move prompt...");
			return false;
		} catch (InvalidPositionException e) {
			System.out.println("This position is invalid. Restarting move prompt...");
			return false;
		} 
